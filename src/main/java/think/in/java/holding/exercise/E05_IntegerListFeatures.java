...
public class E05_IntegerListFeatures {
	...
	public static void main(String[] args) {
		...
		print("4: " + i + " - indexOf:" + ints.indexOf(i));
		...
		print("sub: " + sub);
		copy.retainAll(sub);
		print("13: retainAll:" + copy);
		print(ints);
		copy = new ArrayList<Integer>(ints);
		copy.remove(2);
		print("14: remove(2):" + copy);
		copy.removeAll(sub);
		print("15: " + copy);
		copy.set(1, 9);
		print("16: " + copy);
		...
		print("myList:" + myList);
		// remove(8) 是删掉下标为8的元素
		print(String.format("%s:%s myList:%s", "remove(8)", myList.remove(8), myList));
		// myList.remove(Integer.valueOf(8)) 是删掉8这个元素
		print(String.format("%s:%s myList:%s", "remove(Integer.valueOf(8))", myList.remove(Integer.valueOf(8)), myList));
	}
}