package think.in.java.holding;//: holding/UniqueWords.java
...
public class UniqueWords {
	public static void main(String[] args) {
		Set<String> words = new TreeSet<String>(new TextFile("src/main/java/think/in/java/holding/SetOperations.java", "\\W+"));
