...
public class Hex {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length == 0) {
			System.out.println(format(BinaryFile.read("/Users/lerry/D/workspace/j/my own project/think-in-java/target/classes/net/mindview/util/Hex.class")));
		}
		else {
